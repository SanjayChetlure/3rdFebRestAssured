...
public class ExtentReportgeneration implements ITestListener
{
      ...
      ExtentTest test;         //creating test case entries in reports & update status of test method
	  	...
	  	public void onStart(ITestContext context) 
	    {
	  	    ...
	  	    sparkReporter = new ExtentSparkReporter("src/main/java/P8_ReportGenerationUsing_ExtentReporter/Reports.html");
	        sparkReporter.config().setDocumentTitle("3rd Rest Assured Automation Report");  //title of the report
