...
{	
	...
	public void serialization() throws StreamWriteException, DatabindException, IOException 
	{
		...
		mapper.writeValue(new File("target/friend.json"), fp);     //writing data from java object into file
	}
	...
	{
		FriendsPojo friendPojoObj = mapper.readValue(new File("./target/friend.json"), FriendsPojo.class);    //reading data from json file into java object
